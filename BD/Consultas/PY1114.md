...
### 2. Se crea una columna para cada producto Stock. Mediante un procedimiento con una transacción se calcula el stock actual de cada producto propio sumando la cantidad de ese producto hecho por diferentes panaderos y restándole las compras hechas.
```sql
...
### 1.
```sql
-- Se crea una columna para cada producto Stock. Mediante un procedimiento con una transacción se calcula el stock actual
-- de cada producto propio sumando la cantidad de ese producto hecho por diferentes panaderos y restándole las compras hechas.
